...
double KISSMatcher::getProcessingTime()
{
    return processing_time_;
}

double KISSMatcher::getExtractionTime()
{
    return extraction_time_;
}

double KISSMatcher::getRejectionTime()
{
    return robin_matching_->getRejectionTime();
}

double KISSMatcher::getMatchingTime()
{
    return matching_time_;
}

double KISSMatcher::getSolverTime()
{
    return solver_time_;
}
