...
public:
    ...
    {
        return rejection_time_;
    }

    size_t getNumInitialCorrespondences()
    {
        return num_init_corr_;
    }

    size_t getNumPrunedCorrespondences()
    {
        return num_pruned_corr_;
    }
...
private:
    ...
    bool isValidIndex(const size_t index, const size_t vector_size)
    {
